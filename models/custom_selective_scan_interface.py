...
class MambaInnerFn(torch.autograd.Function):
    ...
    def forward(ctx, xz, x_proj_weight, delta_proj_weight, out_proj_weight, out_proj_bias,
        ...
        # )
        conv1d_out = F.silu(x)  #  TODO: is this correct?
        ...
        ctx.save_for_backward(xz, x_dbl, x_proj_weight,
    ...
    def backward(ctx, dout):
        ...
        (xz, x_dbl, x_proj_weight, delta_proj_weight, out_proj_weight,
        ...
        dconv1d_out = rearrange(dconv1d_out, "d (b l) -> b d l", b=x.shape[0], l=x.shape[-1])
          # No convolution: backprop through SiLU using your snippet

        with torch.enable_grad():
            x_req = x.detach().requires_grad_(True)  # make a leaf that can receive grad
            y = F.silu(x_req)
            (grad_x,) = torch.autograd.grad(y, x_req, dconv1d_out, retain_graph=False, allow_unused=False)
        ...
        return (dxz, dx_proj_weight, ddelta_proj_weight,
...
def mamba_inner_fn(xz, x_proj_weight, delta_proj_weight, out_proj_weight, out_proj_bias,A, B=None, C=None, D=None,
                   delta_bias=None, B_proj_bias=None, C_proj_bias=None, delta_softplus=True, checkpoint_lvl=1,
                   b_rms_weight=None, c_rms_weight=None, dt_rms_weight=None, b_c_dt_rms_eps=1e-6):
    return MambaInnerFn.apply(xz, x_proj_weight, delta_proj_weight,out_proj_weight, out_proj_bias,
